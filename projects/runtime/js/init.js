var init = function (window) {
    ...
    var background = opspark.makeBackground(app,ground); //creates a variable called background to hold the background
    view.addChild(background); //adds background to viewport
    ...
    var hud = opspark.makeHud(); //created a variable for the hud.
    view.addChild(hud); //adds hud to canvas and make it viewable.
    window.hud = hud; //registers hud in the window
